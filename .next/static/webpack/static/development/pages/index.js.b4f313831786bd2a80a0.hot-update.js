...
var Header = function Header() {
  ...
  return __jsx("header", {
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a.dynamic([["1992483948", [header ? '#fff' : 'transparent', header ? '35px' : '45px', header ? '35px' : '45px', header ? _layout_main__WEBPACK_IMPORTED_MODULE_4__["color"].prim : 'rgba(255, 255, 255, .7)']]]) + " " + "animated fadeIn",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 61
    },
...
//# sourceMappingURL=index.js.b4f313831786bd2a80a0.hot-update.js.map