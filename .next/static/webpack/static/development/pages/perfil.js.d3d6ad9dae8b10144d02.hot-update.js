...
/* harmony import */ var _wish_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./wish.scss */ "./components/greenpost/wish.scss");
/* harmony import */ var _wish_scss__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_wish_scss__WEBPACK_IMPORTED_MODULE_7__);
...
var Wish = function Wish() {
  var wish = Object(react_redux__WEBPACK_IMPORTED_MODULE_5__["useSelector"])(function (state) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(wish.found),
      found = _useState2[0],
      setFound = _useState2[1];

  var inputTip = Object(react__WEBPACK_IMPORTED_MODULE_4__["useRef"])();
  user.owner = true;
          ...
          switch (_context.prev = _context.next) {
            case 0:
              try {
                ...
                setFound(wish.found + _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(tip, 10)); //const res = await axios.post('/greenpost/tip', data);
  ...
  return __jsx("div", {
    ...
    onClick: function onClick() {
      return dispatch({
        type: _store_actions__WEBPACK_IMPORTED_MODULE_6__["ON_STORE"]
      });
    },
    disabled: !user.owner
  }, __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_8__["FontAwesomeIcon"], {
    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_9__["faGift"]
    ...
    src: wish.img,
    alt: ""
  }), wish.found === wish.price(__jsx("form", {
    onSubmit: onSubmit
  }, __jsx("input", {
    value: tip,
...
//# sourceMappingURL=perfil.js.d3d6ad9dae8b10144d02.hot-update.js.map