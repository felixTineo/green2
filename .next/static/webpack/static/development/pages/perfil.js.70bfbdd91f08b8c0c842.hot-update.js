...
/* harmony import */ var _logo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./logo */ "./components/layout/logo.jsx");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! next/router */ "./node_modules/next/dist/client/router.js");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _header_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./header.scss */ "./components/layout/header.scss");
...
/* harmony import */ var _mylink_link__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../mylink/link */ "./components/mylink/link.jsx");
...
var SearchBar = function SearchBar() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return axios__WEBPACK_IMPORTED_MODULE_11___default.a.get("/user/search/".concat(value));
  ...
  return __jsx("div", {
    ...
    onChange: onSuggest,
    type: "text"
  }), __jsx("p", null, __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_7__["FontAwesomeIcon"], {
    ...
    return __jsx("li", {
      key: uuid_v1__WEBPACK_IMPORTED_MODULE_14___default()()
    }, __jsx(_mylink_link__WEBPACK_IMPORTED_MODULE_16__["default"], {
      id: item._id
    }, __jsx("div", {
...
var Gift = function Gift() {
  var gifts = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useSelector"])(function (state) {
    return state.nav.notifications.gifts;
  });
  var dispatch = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useDispatch"])();
  var onView = Object(react__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(function () {
    dispatch({
      type: _store_actions__WEBPACK_IMPORTED_MODULE_10__["ON_VIEW_NAV"],
      note: _store_actions__WEBPACK_IMPORTED_MODULE_10__["navView"].GIFT
    });
  });
  return __jsx("div", {
...
var Note = function Note() {
  var notes = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useSelector"])(function (state) {
  ...
  var onView = Object(react__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(function () {
    dispatch({
      type: _store_actions__WEBPACK_IMPORTED_MODULE_10__["ON_VIEW_NAV"],
      note: _store_actions__WEBPACK_IMPORTED_MODULE_10__["navView"].NOTES
    });
  });
  ...
  }, "+", notes.items.length), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["Popover"], {
    target: "note",
    isOpen: pop,
    placement: "bottom"
  }, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["PopoverBody"], null, __jsx("ul", {
...
var Friend = function Friend() {
  var friend = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useSelector"])(function (state) {
  ...
  var onView = Object(react__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(function () {
    dispatch({
      type: _store_actions__WEBPACK_IMPORTED_MODULE_10__["ON_VIEW_NAV"],
      note: _store_actions__WEBPACK_IMPORTED_MODULE_10__["navView"].FRIEND
    });
  });
  ...
  }, "+", friend.items.length), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["Popover"], {
    target: "friend",
    isOpen: pop,
    placement: "bottom"
  }, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["PopoverBody"], null, __jsx("ul", {
...
var Option = function Option() {
  ...
  var dispatch = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useDispatch"])();
  var onLogout = Object(react__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_11___default.a.get('/user/logout');

          case 3:
            dispatch({
              type: _store_actions__WEBPACK_IMPORTED_MODULE_10__["ON_LOGIN"],
              option: false
            });
  ...
  return __jsx("div", {
    ...
    isOpen: pop,
    placement: "bottom"
  }, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["PopoverBody"], {
    style: {
      padding: 0
    }
  }, __jsx("ul", {
...
var Wallet = function Wallet() {
  var wallet = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useSelector"])(function (state) {
    return state.nav.notifications.wallet;
  });
  return __jsx("div", {
    className: "btnicon_cont"
  }, __jsx("p", {
    ...
    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_8__["faCoins"]
  })), __jsx("span", {
    style: {
      fontSize: 16
    }
...
var BarLoader = function BarLoader() {
  var loader = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useSelector"])(function (state) {
    return state.nav.loader;
  });
  var dispatch = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useDispatch"])();
  var onLoader = Object(react__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(function (loader) {
    return dispatch({
...
var Header = function Header() {
  var nav = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useSelector"])(function (state) {
    return state.nav;
  });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_11___default.a.get("/user/notifications");

            case 4:
              res = _context3.sent;
              dispatch({
                type: _store_actions__WEBPACK_IMPORTED_MODULE_10__["ON_NOTIFICATIONS"],
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_15___default()();
    socket.open();
    socket.on("nav:".concat(nav.notifications.id), function (payload) {
      var items = nav.notifications[payload.note].items;
      console.log(items);
      items = [payload.user].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(nav.notifications[payload.note].items));
      console.log(items);
      var reduxPayload = {
        note: payload.action,
        items: items
  ...
  return __jsx("header", {
    ...
    url: "/"
  }), nav.login && width > 992 && __jsx(SearchBar, null)), !nav.login && __jsx(next_link__WEBPACK_IMPORTED_MODULE_12___default.a, {
    href: "/login"
  }, __jsx("button", {
    className: "btn_login"
...
var MyLink = function MyLink(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 3;
              _context.next = 6;
              return axios__WEBPACK_IMPORTED_MODULE_8___default.a.get("/user/perfil/".concat(id));
  ...
  }, children, __jsx(styled_jsx_style__WEBPACK_IMPORTED_MODULE_3___default.a, {
    id: "2059577519"
...
//# sourceMappingURL=perfil.js.70bfbdd91f08b8c0c842.hot-update.js.map