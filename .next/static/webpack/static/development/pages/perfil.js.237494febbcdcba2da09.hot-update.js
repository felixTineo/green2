...
var Wish = function Wish() {
  ...
  }, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(wish).length < 0 && __jsx("div", {
  ...
  }), user.owner ? __jsx("p", null, "Elige un deseo, podria concederse muy pronto.") : __jsx("p", null, user.name, " aun no a elegido un deseo"))), _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(wish) > 0 && __jsx("div", {
    className: "wish_cont"
  }, __jsx("img", {
    src: wish.img,
    alt: ""
  }), __jsx("p", null, wish.name), console.log(wish)));
};
...
//# sourceMappingURL=perfil.js.237494febbcdcba2da09.hot-update.js.map